...
public class UnidadeMedidaJpaController implements Serializable {
    ...
    public void create(UnidadeMedida unidadeMedida) throws PreexistingEntityException, Exception {
        if (unidadeMedida.getUnidadeMedidaPK() == null) {
            unidadeMedida.setUnidadeMedidaPK(new UnidadeMedidaPK());
        }
        ...
        try {
            ...
            if (findUnidadeMedida(unidadeMedida.getUnidadeMedidaPK()) != null) {
                throw new PreexistingEntityException("UnidadeMedida " + unidadeMedida + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(UnidadeMedida unidadeMedida) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                UnidadeMedidaPK id = unidadeMedida.getUnidadeMedidaPK();
    ...
    public void destroy(UnidadeMedidaPK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            try {
                ...
                unidadeMedida.getUnidadeMedidaPK();
    ...
    public UnidadeMedida findUnidadeMedida(UnidadeMedidaPK id) {
        EntityManager em = getEntityManager();
        try {
